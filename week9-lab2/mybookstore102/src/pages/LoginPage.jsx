...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 to-green-700 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent
                  rounded-lg shadow-sm text-sm font-medium text-white bg-red-600
